...
module.exports = {
  ...
  onStart: async function ({ api, event }) {
    ...
    // --- ১. ক্যানভাস দিয়ে ইমেজ কার্ড তৈরি করা ---
    const width = 850; // কার্ডের প্রস্থ সামান্য বাড়ানো হলো
    const height = 1050; // কার্ডের উচ্চতা সামান্য বাড়ানো হলো
    const canvas = createCanvas(width, height);
    const ctx = canvas.getContext('2d');

    // কালার প্যালেট (উজ্জ্বলতা বাড়ানো হলো)
    ...
    // মেইন ইনফো কার্ডের জন্য একটি বড় বক্স আঁকা
    const cardX = 50;
    const cardY = 50;
    const cardWidth = width - 100;
    const cardHeight = height - 100;
    const cardRadius = 25; // রেডিয়াস বাড়ানো হলো
    ...
    ctx.font = 'bold 40px sans-serif'; // ফন্ট সাইজ বাড়ানো হলো
    ...
    try {
        ...
        const imgSize = 130; // ছবির আকার বাড়ানো হলো
    ...
    let textY = cardY + 300;
    const lineHeight = 45; // লাইন স্পেসিং বাড়ানো হলো
    ...
    const drawInfoLine = (label, value, isHighlight = false) => {
        const size = 24; // টেক্সট সাইজ বাড়ানো হলো
